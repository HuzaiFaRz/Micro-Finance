            ...
            <React.Fragment key={index}>
              <SwiperSlide className={`w-full h-full relative`}>
                ...
                <div className="absolute top-1/2 -translate-y-1/2 flex flex-col items-start gap-5 px-6 tablet:px-10 text-main">
                  <h1 className="text-6xl tablet:text-7xl desktop:text-8xl w-full desktop:w-6xl font-elmssans-bold">
                    {heading}
                  </h1>
                  <p className="text-2xl font-elmssans-medium w-full desktop:w-4xl">
                    {paragraph}
                  </p>
                  <NavLink
                    to={"/loan-form"}
